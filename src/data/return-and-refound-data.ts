export const returnAndRefundData = [
  ...
  {
    title: 'How long do I have to return my item(s)?',
    content: [
      'We have a 30-day returns policy which means you have 30 days since you received your jewelry to request a return.',
    ],
  },
  {
    title: 'What can I return?',
    content: [
      'We accept returns on all items - including earrings - as long as they are sent back unworn and in their original packaging. Due to hygiene reasons, we cannot accept earrings which have been worn.',
    ],
  },
  {
  ...
  {
    title: '*Buy 1 Get 1 Free / Buy 2 Get 2 Free Returns*',
    content: [
      'Exchange any item in your order for another item on our site that has the same or lower retail value to the item/s you are exchanging. We will ship the exchanged item(s) completely for free.',
    ],
  },
];
